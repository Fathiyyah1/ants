...
//           Column(
//             children: [
//               Image.asset('asset/images/ant.png'),
//               Image.asset('asset/images/ant.png'),
//             ],
//           ),
//           Column(
...
//                     ChoiceChip(
//                       label: Text('Threat'),
//                       selected: selectedChoice == 'Threat',
//                       onSelected: (selected) {
//                         setState(() {
//                           selectedChoice = selected ? 'Threat' : null;
//                         });
//                       },
//                     ),
//                     const SizedBox(
...
//                     ChoiceChip(
//                       label: Text('Danger'),
//                       selected: selectedChoice == 'Danger',
//                       onSelected: (selected) {
//                         setState(() {
//                           selectedChoice = selected ? 'Danger' : null;
//                         });
//                       },
//                     ),
...
//                         final isMe = selectedChoice == 'Threat';
//                         final message = Message(
//                           text: 'Call for: $selectedChoice',
//                           isMe: isMe,
//                         );
